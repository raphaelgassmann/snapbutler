package ch.teko.gassmanr.view;

import ch.teko.gassmanr.control.IManager;
import ch.teko.gassmanr.control.Manager;
import ch.teko.gassmanr.control.Snapshot;
import ch.teko.gassmanr.control.ValidatedVm;
...
public class App extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        String css =this.getClass().getResource("../res/inc/App.css").toExternalForm();
        scene.getStylesheets().add(css); // Add CSS to JavaFX Class

        primaryStage.setScene(scene);
        primaryStage.setResizable(true);
        primaryStage.getIcons().add(new Image(getClass().getResourceAsStream("../res/img/ico.png")));
        primaryStage.show();
